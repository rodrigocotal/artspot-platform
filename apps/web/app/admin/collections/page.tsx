...
import { FolderOpen, Plus, Pencil, Trash2, Star } from 'lucide-react';
...
export default function AdminCollectionsPage() {
  ...
  const handleSearch = () => fetchCollections(1);
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-display font-serif text-neutral-900 mb-2">Collections</h1>
          <p className="text-body-lg text-neutral-600">Group artworks into curated collections</p>
        </div>
      ...
      {!loading && collections.length > 0 && (
        <p className="text-sm text-neutral-600 mb-4">
          {pagination.total} {pagination.total === 1 ? 'collection' : 'collections'} found
        </p>
      )}
        ...
        <>
          {collections.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h2 className="text-heading-3 font-serif text-neutral-900 mb-2">No collections found</h2>
              <p className="text-neutral-600">Create your first collection to get started.</p>
            </div>
          ) : (
                    ...
                    <tr key={collection.id} className="hover:bg-neutral-50 transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="font-medium text-neutral-900">{collection.title}</span>
